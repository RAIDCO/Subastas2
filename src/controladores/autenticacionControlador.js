// Controlador de autenticación (registro, inicio y cierre de sesión, verificación Gmail OTP)
const bcrypt = require("bcryptjs");
const crypto = require("crypto");

const { Usuario, CodigoVerificacion } = require("../modelos");
const { enviarCodigoVerificacion } = require("../servicios/correoServicio");
...
//====================================
// SOLICITAR CÓDIGO DE VERIFICACIÓN GMAIL
